...
public class BlockCompressor extends BlockContainer
{
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityCompressor var10 = (TileEntityCompressor)par1World.getBlockTileEntity(par2, par3, par4);
            ...
            if (var10 != null)
            {
                par5EntityPlayer.openGui(CocoCraft2.instance, 6, par1World, par2, par3, par4);
            }
