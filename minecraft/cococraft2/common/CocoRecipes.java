...
public class CocoRecipes 
{
	...
	{	
		...
		gr.addRecipe(new ItemStack(items.Ingots, 2, 11), new Object[]{"GRR", "RSR", "RRG", 'G', Item.gunpowder, 'R', Item.redstone, 'S', Item.sugar});
		...
		gr.addRecipe(new ItemStack(items.Hammer, 1), new Object[]{"SSS", " I ", "   ", 'S', new ItemStack(blocks.OreBlock, 1, 4), 'I', Item.stick});
		
		gr.addShapelessRecipe(new ItemStack(items.Ingots, 11, 4), new Object[]{Block.dragonEgg});
		gr.addRecipe(new ItemStack(items.Ingots, 4, 5), new Object[]{"X ", " X", 'X', Item.diamond});
	}
	private static void addToolRecipes() 
	{
		...
		gr.addRecipe(new ItemStack(items.DragonStonePickaxe, 1), new Object[] {"III", " S ", " S ", 'I', new ItemStack(items.Ingots, 1, 4), 'S', new ItemStack(items.Ingots, 1, 5)});
		gr.addRecipe(new ItemStack(items.DragonStoneAxe, 1), new Object[] {"II ", "IS ", " S ", 'I', new ItemStack(items.Ingots, 1, 4), 'S', new ItemStack(items.Ingots, 1, 5)});
